...
const Footer: React.FC = () => {
  return (
    <footer className="bg-theme-dark pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Build custom, lightweight WordPress themes in minutes. Choose from industry-specific designs and modules for a perfect fit.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <FooterLink href="/builder">Theme Builder</FooterLink>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <Input
                ...
                className="bg-theme-dark border-gray-700 focus:border-theme-blue"
              />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} ThemeMorphic. All rights reserved.
          </p>
